...
public class AgregarPost extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        // Creamos una instacia de nuestra clase UsuariosOperaciones
        UsuariosOperaciones op=new UsuariosOperaciones();
        // el objeto op recibe una instancia de la clase Usuarios
        ...
        (
                ...
                request.getParameter("direc")
        ));
        // Por ultimo redireccionamos a la parte del listado de usuarios
